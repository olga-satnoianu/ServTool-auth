...
<div class="w-full h-[100vh] flex">
    ...
    <div class="w-full lg:w-1/4 h-full flex flex-col items-center justify-center px-12">
        <img class="mb-16" src="/servtool_icon.jpg">
        <p class="text-2xl font-bold text-center">Welcome</p>
        <form method="POST" action="{{ route('register') }}" class="w-full mt-12">
            {{ csrf_field() }}

            <div class="form-group w-full">
                <label class="font-semibold text-sm" for="email">Enter your first name</label><br>
                <input type="text" name="first_name" id="first_name"
                       class="mt-1 rounded-md w-full border border-gray-300 text-sm h-12 px-4">
            </div>

            <div class="form-group w-full">
                <label class="font-semibold text-sm" for="email">Enter your last name</label><br>
            ...
            <div class="password w-full mt-3">
                <label class="font-semibold text-sm" for="password">Enter your password</label><br>
                <input type="password" name="password" id="password"
                       class="mt-1 rounded-md w-full border border-gray-300 text-sm h-12 px-4">
            </div>

{{--            <div class="password w-full mt-3">--}}
{{--                <label class="font-semibold text-sm" for="password_confirmation">Confirm your password</label><br>--}}
